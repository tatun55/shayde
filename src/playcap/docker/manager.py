...
if TYPE_CHECKING:
    from playcap.config.schema import PlayCapConfig, PlatformType

logger = logging.getLogger(__name__)

# Docker compose template
COMPOSE_TEMPLATE = """# PlayCap Playwright Container
# Auto-generated by PlayCap
...
def get_package_docker_dir() -> Path:
    """Get the docker directory in the playcap package."""
    ...
    import playcap
    package_dir = Path(playcap.__file__).parent.parent.parent / "docker"
    return package_dir
...
class DockerManager:
    ...
    def _generate_compose_file(self) -> Path:
        ...
        compose_dir = Path(tempfile.gettempdir()) / "playcap"
    ...
    def build_image(self, force: bool = False) -> bool:
        """Build the custom PlayCap Docker image with fonts."""
        if not self.config.docker.use_custom_image:
